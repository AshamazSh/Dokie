...
@interface FolderNameTableViewCell()
...
@implementation FolderNameTableViewCell
...
- (void)setup {
    ...
    self.iconImageView.image = [[UIImage imageNamed:@"folder.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
